...
Save the YAML below as `captureorder-deployment.yaml` or download it from [captureorder-deployment.yaml](https://raw.githubusercontent.com/cosmos0703/gke-workshop/928f03cdb5034e56121a2d3c9d1289467392da4c/yaml-solutions/01.%20challenge-02/captureorder-deployment.yaml)
...
Save the YAML below as `captureorder-service.yaml` or download it from [captureorder-service.yaml](https://raw.githubusercontent.com/cosmos0703/gke-workshop/928f03cdb5034e56121a2d3c9d1289467392da4c/yaml-solutions/01.%20challenge-02/captureorder-service.yaml)
...
Save the YAML below as `frontend-deployment.yaml` or download it from [frontend-deployment.yaml](https://raw.githubusercontent.com/cosmos0703/gke-workshop/main/yaml-solutions/01.%20challenge-02/frontend-deployment.yaml)
...
There are many options when considering Kubernetes ingress controllers, including the [GKE Ingress for HTTP(s) Load Balancing](https://cloud.google.com/kubernetes-engine/docs/concepts/ingress?hl=ko)  The most commonly used is the [nginx-ingress](https://github.com/helm/charts/tree/master/stable/nginx-ingress) controller.
...
Save the YAML below as `frontend-service.yaml` or download it from [frontend-service.yaml](https://raw.githubusercontent.com/cosmos0703/gke-workshop/main/yaml-solutions/01.%20challenge-02/frontend-service.yaml)
...
Save the YAML below as `frontend-ingress.yaml` or download it from [frontend-ingress.yaml](https://github.com/cosmos0703/gke-workshop/blob/main/yaml-solutions/01.%20challenge-02/frontend-ingress.yaml)
